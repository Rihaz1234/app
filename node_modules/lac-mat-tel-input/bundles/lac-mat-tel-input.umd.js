(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material/form-field'), require('@angular/material/input'), require('rxjs'), require('@angular/forms'), require('@angular/cdk/a11y'), require('@angular/cdk/coercion'), require('libphonenumber-js'), require('@angular/material/button'), require('@angular/material/divider'), require('@angular/material/menu'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('lac-mat-tel-input', ['exports', '@angular/core', '@angular/material/form-field', '@angular/material/input', 'rxjs', '@angular/forms', '@angular/cdk/a11y', '@angular/cdk/coercion', 'libphonenumber-js', '@angular/material/button', '@angular/material/divider', '@angular/material/menu', '@angular/common'], factory) :
    (global = global || self, factory(global['lac-mat-tel-input'] = {}, global.ng.core, global.ng.material.formField, global.ng.material.input, global.rxjs, global.ng.forms, global.ng.cdk.a11y, global.ng.cdk.coercion, global['1']['7']['58'], global.ng.material.button, global.ng.material.divider, global.ng.material.menu, global.ng.common));
}(this, (function (exports, core, formField, input, rxjs, forms, a11y, coercion, libphonenumberJs, button, divider, menu, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LacMatTelInputComponent = /** @class */ (function () {
        function LacMatTelInputComponent(ngControl, fm, elRef, changeDetector) {
            ...
            this.countryChange = new rxjs.Subject();
        ...
        Object.defineProperty(LacMatTelInputComponent.prototype, "value", {
            set: function (v) {
                this._value = v ? "+" + libphonenumberJs.getCountryCallingCode(this.selectedCountry) + " " + v : v;
                if (this.internationalFormat && this._value) {
                    var phoneNumber = libphonenumberJs.parsePhoneNumberFromString(this._value);
        ...
        Object.defineProperty(LacMatTelInputComponent.prototype, "disabled", {
            ...
            set: function (value) {
                this.inputDisabled = coercion.coerceBooleanProperty(value);
                this.stateChanges.next();
            },
            enumerable: true,
            configurable: true
        ...
        Object.defineProperty(LacMatTelInputComponent.prototype, "internationalFormat", {
            ...
            set: function (format) {
                this._internationalFormat = coercion.coerceBooleanProperty(format);
        ...
        LacMatTelInputComponent.prototype.onCountrySelected = function (code, noPhoneReset) {
            ...
            var example = libphonenumberJs.getExampleNumber(code, Examples).formatNational();
            ...
            for (var i = maxExample.length; i >= 0; i--) {
                ...
                var testPhone = libphonenumberJs.parsePhoneNumberFromString(test, code);
                if (testPhone && testPhone.isValid()) {
                    var maxInput = new libphonenumberJs.AsYouType(code).input(test);
        ...
        LacMatTelInputComponent.prototype.onInputChanged = function (e) {
            ...
            if (e.startsWith('+')) { //handles pasting of a complete international number
                try {
                    var pastedNumber_1 = libphonenumberJs.parsePhoneNumberFromString(e);
            ...
            setTimeout(function () {
                var formatted = new libphonenumberJs.AsYouType(_this.selectedCountry).input(numbersOnly);
        ...
        LacMatTelInputComponent = LacMatTelInputComponent_1 = __decorate([
            core.Component({
                ...
                providers: [{ provide: formField.MatFormFieldControl, useExisting: LacMatTelInputComponent_1 }],
                styles: [""]
            }),
            __param(0, core.Optional()), __param(0, core.Self()),
    ...
    var SearchPipe = /** @class */ (function () {
        ...
        SearchPipe.prototype.transform = function (country, query) {
            if (!query || query === '') {
                return true;
            }
    ...
    var LacMatTelInputModule = /** @class */ (function () {
        function LacMatTelInputModule() {
        }
        LacMatTelInputModule = __decorate([
            core.NgModule({
        ...
        return LacMatTelInputModule;
    }());

    var phoneNumberValidator = function (control) {
        var error = { invalidPhone: true };
        var numberInstance;
        if (control.value) {
            try {
    ...
    exports.LacMatCountrySelectorComponent = LacMatCountrySelectorComponent;
    exports.LacMatTelInputComponent = LacMatTelInputComponent;
    exports.LacMatTelInputModule = LacMatTelInputModule;
    exports.phoneNumberValidator = phoneNumberValidator;
    exports.ɵa = SearchPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=lac-mat-tel-input.umd.js.map
